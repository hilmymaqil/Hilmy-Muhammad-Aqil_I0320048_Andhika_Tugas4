...
print("Lima karakter pertama adalah '%s'" % s[:5]) # mulai ke 5
print("Lima karakter berikutnya adalah '%s'" % s[5:10]) # 5 ke 10
...
print("Lima karakter terakhir adalah '%s'" % s[-5:]) # 5th-from-last to end# konversiin ke upercase
...
if s.startswith("nadhira"):
 print("String dimulai dengan 'nadhira'. GOOD!")

# cek bagaimana string itu diakhiri
if s.endswith("ayam"):
 print("String diakhiri dengan 'ayam'. GOOD!")
